        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="{{ route('overview') }}"
                    class="flex items-center p-2 text-white rounded-lg group hover:bg-white hover:text-blue-700 hover:scale-105 transition duration-300 ease-in-out">
            ...
            <li>
                <a href="{{route('borrows')}}"
                    class="flex items-center p-2 text-white rounded-lg hover:bg-white hover:text-blue-700 group">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-white" fill="white"
                        viewBox="0 0 576 512">
                        <path
            ...
            <li>
                <button type="button"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="shrink-0 w-5 h-5 text-white" fill="none"
...
-->
            ...
            <li>
                <button type="button"
                    class="flex items-center w-full p-2 text-white transition duration-75 rounded-lg group hover:bg-white hover:text-blue-700"
                    aria-controls="items-dropdown" data-collapse-toggle="items-dropdown">
                    <svg class="shrink-0 w-5 h-5 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                ...
                <ul id="items-dropdown" class="hidden py-2 space-y-2">
                    <li>
                        <a href="{{route('items')}}"
                            class="flex items-center p-2 text-white rounded-lg hover:bg-white hover:text-blue-700 group">
